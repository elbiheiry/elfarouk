            ...
            <div class="widget-content">
                <div class="col-sm-12">
                    <div class="add-user-form">
                        <form class="ajax-form" method="post" action="{{route('admin.products.ingredients' , ['id' => $id])}}"
                        ...
                        <table id="datatableX" class="table table-hover table-bordered display nowrap" cellspacing="0"
                            ...
                            @foreach($ingredients as $index => $ingredient)
                                <tr class="ticket-tr">
                                    ...
                                    <td>
                                        <a href="{{route('admin.products.ingredients.edit' , ['id' => $ingredient->id])}}"
                                           class="icon-btn fa fa-wrench" title="Edit"></a>
                                        <button
                                                data-url="{{route('admin.products.ingredients.delete' ,['id' => $ingredient->id])}}"
                                                data-toggle="modal"
