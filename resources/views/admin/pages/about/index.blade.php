                        ...
                        <form class="ajax-form" method="post" action="{{route('admin.about.edit')}}"
                            ...
                            <div class="col-sm-6">
                                <div class="form-group img-block">
                                    <label>Image</label>
                                    <img src="{{asset('storage/app/public/about/'.$about->image)}}"
                                    ...
                                    <div class="text-danger text-center">Image size should be: 420px * 420px</div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6 form-group">
                                ...
                                <input class="form-control" type="text" name="video" value="{{$about->video}}">
                            </div>
